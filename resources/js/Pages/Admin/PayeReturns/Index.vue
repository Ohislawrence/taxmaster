<template>
    <AdminLayout>
        <Head title="PAYE Returns" />

        <div class="space-y-8">
            <!-- Header -->
            <div class="mb-8">
                <h1 class="text-4xl font-bold text-gray-900">PAYE Returns Management</h1>
                <p class="text-gray-600 mt-2">Monitor all PAYE returns across all businesses</p>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <div class="bg-white rounded-lg shadow p-6">
                    ...
                    <p class="text-3xl font-bold text-blue-600 mt-2">₦{{ formatCurrency(stats.totalTax) }}</p>
                </div>
            </div>
            ...
            <div class="bg-white rounded-lg shadow p-6">
                <div class="flex justify-between items-center mb-6">
                    ...
                    <div class="flex gap-2">
                        <Link
                            :href="route('admin.paye-returns.export')"
                    ...
                    <table class="w-full text-sm">
                        <thead class="bg-gray-50 border-b border-gray-200">
                            <tr>
                                ...
                                <th class="px-6 py-3 text-right font-semibold text-gray-900">Staff Count</th>
                        ...
                        <tbody class="divide-y divide-gray-200">
                            <tr v-for="ret in returns.data" :key="ret.id" class="hover:bg-gray-50">
                                ...
                                <td class="px-6 py-4 text-right font-semibold">₦{{ formatCurrency(ret.total_paye_tax) }}</td>
                                <td class="px-6 py-4">
                                    <Link
                                        :href="route('admin.paye-returns.show', ret.id)"
...
const handleFilter = () => {
    Link.visit(route('admin.paye-returns.index', {
