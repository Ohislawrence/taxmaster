        ...
        <div class="space-y-6">
            ...
            <div class="bg-white rounded-lg shadow overflow-hidden">
                ...
                <div v-if="subscriptions.links.length > 3" class="bg-white px-6 py-4 border-t border-gray-200 flex justify-center space-x-2">
                    <Link v-for="link in subscriptions.links" :key="link.url || link.label" :href="link.url || '#'" :class="link.active ? 'bg-blue-600 text-white' : 'text-gray-600'" class="px-3 py-1 rounded">
                        {{ link.label }}
                    </Link>
                </div>
            </div>
