...
const submit = async () => {
    ...
    await router.post('/api/blog-posts', data);
};
</script>
            ...
            <div>
                ...
                <input v-model="form.published_at" type="datetime-local" class="w-full rounded border-gray-300" />
                    ...
                    <div class="flex gap-4">
                        <button type="submit" class="bg-blue-600 text-white px-6 py-2 rounded-lg font-semibold hover:bg-blue-700 transition">Publish</button>
