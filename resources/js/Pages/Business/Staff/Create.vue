            ...
            <form @submit.prevent="submitForm" class="bg-white rounded-lg shadow p-6 mt-6">
                ...
                <div class="mb-6">
                    <label class="block text-sm font-medium text-gray-700 mb-2">
                        ...
                        <span
                            ...
                            title="Provide the staff member's tax ID if available. This helps match payroll records with official filings."
                        >
                            i
                        </span>
                    </label>
                ...
                <div class="mb-6">
                    <label class="block text-sm font-medium text-gray-700 mb-2">
                        ...
                        <span
                            class="ml-2 inline-flex h-4 w-4 items-center justify-center rounded-full bg-blue-100 text-[10px] font-bold text-blue-700"
                            title="Enter the gross monthly salary before deductions. PAYE is calculated from this amount."
                        >
                            i
                        </span>
                    </label>
                ...
                <div class="grid grid-cols-2 gap-6 mb-6">
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-2">
                            ...
                            <span
                                class="ml-2 inline-flex h-4 w-4 items-center justify-center rounded-full bg-blue-100 text-[10px] font-bold text-blue-700"
                                title="Select the contract type for this staff member. This can affect tax calculations and reporting."
                            >
                                i
                            </span>
                        </label>
                ...
                <div class="mb-6">
                    <label class="block text-sm font-medium text-gray-700 mb-2">
                        ...
                        <span
                            class="ml-2 inline-flex h-4 w-4 items-center justify-center rounded-full bg-blue-100 text-[10px] font-bold text-blue-700"
                            title="Use the staff member's official start date for payroll and compliance tracking."
                        >
                            i
                        </span>
                    </label>
