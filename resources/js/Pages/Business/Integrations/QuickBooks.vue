                    ...
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="mt-2 text-sm text-gray-600">
                                Automatically sync invoices, bills, and expenses from QuickBooks Online
                            </p>
                        </div>
                ...
                <div class="mb-6">
                    <div v-if="connection && connection.status === 'active'" class="bg-white shadow rounded-lg p-6">
                        <div class="flex items-start justify-between">
                            <div class="flex items-center space-x-4">
                                ...
                                <div>
                                    <h3 class="text-lg font-semibold text-gray-900">Connected to QuickBooks</h3>
                                    <p class="mt-1 text-sm text-gray-600">{{ connection.company_name }}</p>
                    ...
                    <div v-else-if="connection && connection.status === 'expired'" class="bg-yellow-50 border-l-4 border-yellow-400 p-6 rounded-r-lg">
                        <div class="flex items-start">
                            ...
                            <div class="ml-3 flex-1">
                                ...
                                <div class="mt-4">
                                    <a
                                        :href="route('business.integrations.quickbooks.connect')"
                    ...
                    <div v-else-if="!connection || !connection.has_credentials" class="bg-white shadow rounded-lg p-8">
                        <div class="max-w-2xl mx-auto">
                            <div class="text-center mb-8">
                                ...
                                <h3 class="text-xl font-bold text-gray-900 mb-2">Set Up QuickBooks Integration</h3>
                                <p class="text-sm text-gray-600">
                                    To connect TaxMaster with your QuickBooks account, you need to create a QuickBooks app and provide its credentials.
                                </p>
                            </div>

                            <!-- Instructions -->
                            <div class="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6">
                                <h4 class="font-semibold text-blue-900 mb-2">How to get your QuickBooks credentials:</h4>
                                <ol class="text-sm text-blue-800 space-y-1 list-decimal list-inside">
                                    <li>Go to <a href="https://developer.intuit.com/" target="_blank" class="underline font-medium">QuickBooks Developer Portal</a></li>
                                    <li>Create a free developer account and sign in</li>
                                    <li>Click "Create an app" → Select "QuickBooks Online"</li>
                                    <li>Copy your <strong>Client ID</strong> and <strong>Client Secret</strong></li>
                                    <li>Set Redirect URI to: <code class="bg-white px-2 py-0.5 rounded text-xs">{{ credentialsForm.redirect_uri }}</code></li>
                            ...
                            <form @submit.prevent="saveCredentials" class="space-y-5">
                                <div>
                                    ...
                                    <input
                                        ...
                                        type="text"
                                        required
                                        placeholder="e.g., ABCxxxQAnygfO7bOvl8RrNMXxxxT2M"
                                ...
                                <div>
                                    ...
                                    />
                                    <p class="mt-1 text-xs text-gray-500">Use this exact URL in your QuickBooks app settings</p>
                                </div>
                                ...
                                <div>
                                    ...
                                    <p class="mt-1 text-xs text-gray-500">Use Sandbox for testing, Production for real data</p>
                                </div>
                                ...
                                <div class="flex items-center space-x-3 pt-4">
                                    <button
                                        ...
                                        class="flex-1 inline-flex justify-center items-center px-6 py-3 border border-transparent rounded-md shadow-sm text-base font-medium text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 disabled:opacity-50"
                                    >
                    ...
                    <div v-else-if="connection && connection.has_credentials && connection.status === 'credentials_set'" class="bg-white shadow rounded-lg p-12 text-center">
                        ...
                        <p class="text-sm text-gray-600 mb-6 max-w-md mx-auto">
                            Your QuickBooks app credentials are set up. Now connect your QuickBooks account to start syncing data.
                        </p>
                        <div class="mb-3">
                            <span class="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium bg-gray-100 text-gray-700">
                                Environment: <strong class="ml-1 capitalize">{{ connection.environment }}</strong>
                            </span>
                        </div>
                        <a
                            :href="route('business.integrations.quickbooks.connect')"
                        ...
                        <p class="mt-4 text-xs text-gray-500">
                            Secure OAuth 2.0 authentication • Your QuickBooks login is never shared with TaxMaster
                        </p>
                        <button
                                                ...
                                                <div class="mt-6 space-y-6">
                                                    ...
                                                    <div class="flex items-center justify-between">
                                                        ...
                                                        <button
                                                            ...
                                                            :class="[
                                                                settingsForm.auto_sync_enabled ? 'bg-blue-600' : 'bg-gray-200',
                                                    ...
                                                    <div v-if="settingsForm.auto_sync_enabled">
                                                        ...
                                                        <p class="mt-1 text-xs text-gray-500">
                                                            How often to automatically sync data from QuickBooks
                                                        </p>
                                                    </div>
...
const credentialsForm = reactive({
    client_id: '',
    client_secret: '',
    redirect_uri: typeof window !== 'undefined' ? window.location.origin + '/business/integrations/quickbooks/callback' : '/business/integrations/quickbooks/callback',
    environment: 'sandbox'
});
...
const saveSettings = () => {
    ...
    router.patch(route('business.integrations.quickbooks.update-settings'), settingsForm, {
        onSuccess: () => {
...
const saveCredentials = () => {
    ...
    router.post(route('business.integrations.quickbooks.save-credentials'), credentialsForm, {
        onSuccess: () => {
...
const startSync = () => {
    syncing.value = true;
    router.post(route('business.integrations.quickbooks.sync'), syncForm, {
        onSuccess: () => {
...
const confirmDisconnect = () => {
    if (confirm('Are you sure you want to disconnect QuickBooks? Existing synced transactions will not be deleted, but new data will not sync.')) {
        router.post(route('business.integrations.quickbooks.disconnect'), {}, {
            onSuccess: () => {
...
const viewLogDetails = (log) => {
    router.get(route('business.integrations.quickbooks.logs.show', log.id));
};
</script>
