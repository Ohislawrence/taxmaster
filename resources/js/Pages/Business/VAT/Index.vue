    ...
    <div class="space-y-6">
      ...
      <div class="flex items-center justify-between">
        <div>
          ...
          <p class="mt-2 text-gray-600">Manage your monthly Value Added Tax returns (Form 002)</p>
        </div>
        <Link
      ...
      <div class="grid grid-cols-1 md:grid-cols-5 gap-4">
        ...
        <div class="bg-white rounded-lg shadow p-6">
          <div class="flex items-center justify-between">
            <div>
              <p class="text-gray-600 text-sm font-medium">Total VAT Paid</p>
              <p class="text-3xl font-bold text-gray-900 mt-2">₦{{ formatCurrency(stats.total_vat_paid) }}</p>
            </div>
        ...
        <div class="bg-white rounded-lg shadow p-6">
          <div class="flex items-center justify-between">
            <div>
              ...
              <p class="text-3xl font-bold text-red-600 mt-2">{{ stats.overdue_returns }}</p>
            </div>
        ...
        <div class="bg-white rounded-lg shadow p-6">
          <div class="flex items-center justify-between">
            <div>
              <p class="text-gray-600 text-sm font-medium">Pending Refunds</p>
              <p class="text-3xl font-bold text-purple-600 mt-2">{{ stats.pending_refunds }}</p>
            </div>
            <div class="bg-purple-100 rounded-lg p-3">
              <i class="fas fa-arrow-left text-purple-600 text-xl"></i>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="bg-white rounded-lg shadow">
        ...
        <div v-else class="px-6 py-12 text-center">
          ...
          <p class="text-gray-600 mb-4">No VAT returns yet</p>
          <Link
            :href="route('business.vat.create')"
            class="inline-flex items-center px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition"
          >
