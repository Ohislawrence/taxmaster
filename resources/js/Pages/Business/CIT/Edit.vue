  ...
  <BusinessLayout>
    ...
    <div class="space-y-6 max-w-4xl mx-auto">
      ...
      <div class="flex items-center justify-between">
        <div>
          <h1 class="text-2xl sm:text-3xl font-bold text-gray-900">Edit CIT Return</h1>
      ...
      <form @submit.prevent="submit" class="space-y-6">
        ...
        <div class="bg-white shadow rounded-lg">
          <div class="px-6 py-4 flex flex-col sm:flex-row items-center justify-between gap-3">
            <Link :href="route('business.cit.show', citReturn.id)" class="text-gray-700 hover:text-gray-900">
...
const form = useForm({
  ...
  turnover: props.citReturn.turnover || '',
  gross_assets: props.citReturn.gross_assets || '',
  paid_up_capital: props.citReturn.paid_up_capital || '',
  revenue: props.citReturn.revenue || '',
  cost_of_goods_sold: props.citReturn.cost_of_goods_sold || '',
  depreciation: props.citReturn.depreciation || '',
  amortization: props.citReturn.amortization || '',
  other_add_backs: props.citReturn.other_add_backs || '',
  capital_allowances: props.citReturn.capital_allowances || '',
  allowable_expenses: props.citReturn.allowable_expenses || '',
  other_deductions: props.citReturn.other_deductions || '',
  withholding_tax: props.citReturn.withholding_tax || '',
  advance_tax: props.citReturn.advance_tax || '',
...
const submit = () => {
  form.transform(data => ({
    ...data,
    status: 'submitted',
  })).put(route('business.cit.update', props.citReturn.id));
};
