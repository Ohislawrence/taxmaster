  ...
  <BusinessLayout>
    ...
    <div class="space-y-6 max-w-3xl mx-auto">
      ...
      <div class="flex items-center justify-between">
        <div>
          <h1 class="text-3xl font-bold text-gray-900">New CIT Return</h1>
          <p class="mt-2 text-gray-600">Record a new corporate income tax return for your business</p>
        </div>
      </div>
        ...
        <div class="flex">
          ...
          <div class="ml-3">
            <p class="text-sm text-blue-700">
              <strong>How CIT is calculated:</strong> CIT Rate (30%) × Assessable Profit. Minimum Tax applies if profit < ₦25M.
              TaxMaster auto-calculates based on your financial data.
            </p>
          </div>
        </div>
      </div>
      ...
      <form @submit.prevent="submit" class="bg-white shadow rounded-lg">
        ...
        <div class="bg-gray-50 px-6 py-4 rounded-b-lg flex items-center justify-between space-x-3">
          <Link href="/business/cit" class="text-gray-700 hover:text-gray-900">Cancel</Link>
          <div class="space-x-3">
            <button
              type="button"
              @click="saveDraft"
            ...
            >
              ...
              {{ processing ? 'Saving...' : 'Create & Submit' }}
            </button>
          </div>
        </div>
      </form>
...
const submit = () => {
  form.post(route('business.cit.store'));
};
