...
const capabilities = [
    ...
    { icon: 'bank', title: 'Bank & Accounting Integrations', desc: 'Connect your bank via Mono and sync with QuickBooks, Zoho Books, Sage, or Xero. Transactions auto-categorised for tax purposes.' },
