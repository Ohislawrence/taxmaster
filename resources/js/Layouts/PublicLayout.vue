                ...
                <div class="grid gap-12 lg:grid-cols-6">
                    ...
                    <div class="lg:col-span-2">
                        ...
                        <div class="mt-6 flex gap-4">
                            ...
                            <a href="https://www.instagram.com/taxmaster_ng/" target="_blank" rel="noopener" class="flex h-9 w-9 items-center justify-center rounded-full bg-white text-slate-400 shadow-sm ring-1 ring-slate-200 transition-all hover:text-slate-900 hover:shadow-md" aria-label="Instagram">
                                <svg class="h-4 w-4" fill="currentColor" viewBox="0 0 24 24">
                            ...
                            <a href="https://www.threads.com/@taxmaster_ng" target="_blank" rel="noopener" class="flex h-9 w-9 items-center justify-center rounded-full bg-white text-slate-400 shadow-sm ring-1 ring-slate-200 transition-all hover:text-slate-900 hover:shadow-md" aria-label="Threads">
                                <svg class="h-4 w-4" fill="currentColor" viewBox="0 0 24 24">
                                    <path d="M16.43 10.22c-.2-.1-.43-.2-.68-.28-.05-1.1-.45-1.95-1.2-2.55-.76-.62-1.83-.94-3.17-.94-1.51 0-2.72.45-3.6 1.33-.87.88-1.32 2.07-1.32 3.54 0 1.48.44 2.66 1.31 3.53.88.87 2.09 1.3 3.61 1.3 1.22 0 2.23-.27 3-.8.73-.51 1.13-1.18 1.19-1.98.03-.42-.06-.77-.27-1.05-.23-.3-.59-.5-1.05-.58-.46-.08-.95-.03-1.47.15-.48.16-.9.4-1.24.72-.36.33-.57.67-.62 1.01-.05.34.04.65.28.92-.7.27-1.36.31-1.99.11-.58-.18-1.05-.53-1.39-1.04-.34-.5-.51-1.1-.51-1.8 0-.69.17-1.3.5-1.81.35-.52.81-.88 1.39-1.08.62-.22 1.3-.2 2.02.07.59.22 1.01.6 1.26 1.14-.7-.08-1.39-.02-2.05.18-.69.21-1.26.55-1.69 1.02-.45.49-.67 1.04-.66 1.63.02.64.28 1.17.78 1.59.5.42 1.2.65 2.08.67 1.23.03 2.26-.32 3.06-1.03.82-.73 1.26-1.72 1.31-2.94.36.16.66.36.88.6.38.41.58.95.59 1.63 0 .95-.36 1.74-1.08 2.36-.71.61-1.69.92-2.92.92-1.95 0-3.47-.53-4.54-1.58-1.07-1.06-1.62-2.57-1.62-4.49 0-1.89.54-3.39 1.61-4.45 1.08-1.08 2.6-1.62 4.52-1.62 1.74 0 3.14.42 4.17 1.26.99.8 1.58 1.92 1.75 3.33.27.1.52.21.74.35.97.57 1.46 1.49 1.46 2.74 0 1.4-.54 2.54-1.61 3.38-1.08.85-2.52 1.28-4.28 1.28-1.4 0-2.63-.2-3.67-.59-1.04-.39-1.9-.98-2.56-1.75-.66-.78-1.05-1.72-1.15-2.8h1.83c.15 1.04.68 1.86 1.57 2.43.9.58 2.22.87 3.93.87 1.34 0 2.4-.25 3.14-.75.73-.5 1.1-1.16 1.1-1.95 0-.68-.24-1.17-.71-1.47z" />
                                </svg>
                            </a>
                        </div>
                    </div>
