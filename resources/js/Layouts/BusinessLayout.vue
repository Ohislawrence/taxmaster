                        ...
                        <div class="relative user-menu-container">
                            ...
                            >
                                <div v-if="showUserMenu" class="absolute right-0 mt-2 w-56 bg-white rounded-xl shadow-lg border border-gray-100 py-1.5 z-50 overflow-hidden">
                                    ...
                                    <Link href="/business/integrations" class="flex items-center gap-3 px-4 py-2.5 text-sm text-gray-700 hover:bg-gray-50 transition-colors">
                                        <svg class="w-4 h-4 text-gray-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div class="mt-8 pt-6 border-t border-gray-200/70">
                        ...
                        <div class="space-y-0.5">
                            <Link
                                ...
                                :class="[
                                    'flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium transition-all group',
                                    isActive('/business/integrations')
                                        ? 'bg-gradient-to-r from-blue-50 to-indigo-50/50 text-blue-600'
                                        : 'text-gray-600 hover:bg-gray-100/80'
                                ]"
                            >
                                <svg class="w-5 h-5 transition-transform group-hover:scale-110" :class="isActive('/business/integrations') ? 'text-blue-600' : 'text-gray-400 group-hover:text-gray-600'" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M13.828 10.172a4 4 0 00-5.656 0l-4 4a4 4 0 105.656 5.656l1.102-1.101m-.758-4.899a4 4 0 005.656 0l4-4a4 4 0 00-5.656-5.656l-1.1 1.1" />
                                </svg>
                                <span class="flex-1">Integrations</span>
                                <span v-if="isActive('/business/integrations')" class="w-1 h-1 bg-blue-600 rounded-full"></span>
                            </Link>
                            <Link
                            ...
                            <a
                                href="/help"
                                class="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium transition-all group text-gray-600 hover:bg-gray-100/80"
                                target="_blank"
                            >
                                <svg class="w-5 h-5 transition-transform group-hover:scale-110 text-gray-400 group-hover:text-gray-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
